# P Adic Hodge Realizations — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/p-adic-hodge-realizations-canonical-lane-mathlib.git
cd p-adic-hodge-realizations-canonical-lane-mathlib
lake exe
lake build
```
